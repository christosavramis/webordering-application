package com.webordering.applicationserver.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.webordering.applicationserver.service.EmailAlreadyUsedException ||
            ex instanceof com.webordering.applicationserver.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.webordering.applicationserver.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.webordering.applicationserver"
        );
    }
}
